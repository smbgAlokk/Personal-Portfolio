    ...
    <section id="contact" className="bg-gradient-to-b from-primary to-primary-light data-pattern-bg">
      <div className="section-container">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="section-title">Let's Work Together <span className="text-highlight">🚀</span></h2>
          <div className="max-w-3xl mx-auto">
            <p className="text-center text-gray-300 mb-12">
              Open to <span className="text-accent font-semibold">Data Analyst</span> and <span className="text-highlight font-semibold">Data Engineering</span> opportunities. Let's connect and create something amazing with data. Whether you need help with data analysis, visualization, or building data pipelines, I'm here to help transform your raw data into valuable insights that drive business decisions.
            </p>
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <a
                  ...
                  className="flex items-center text-gray-300 hover:text-white transition-all duration-300 group" whileHover={{ x: 5 }} whileTap={{ scale: 0.98 }}
                >
