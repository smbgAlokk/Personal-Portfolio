...
const GitHubAnalytics = () => {
  return (
    <section id="github" className="bg-gradient-to-b from-primary-dark to-primary text-white">
      <div className="section-container">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="section-title">GitHub & Analytics <span className="text-accent">📊</span></h2>
          
          {/* GitHub Stats */}
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-primary-light p-6 rounded-xl border border-accent/20">
              <h3 className="text-xl font-semibold text-accent mb-4">GitHub Stats</h3>
            ...
            {/* Contribution Graph */}
            <div className="bg-primary-light p-6 rounded-xl border border-accent/20">
              <h3 className="text-xl font-semibold text-accent mb-4">Contribution Graph</h3>
          ...
          {/* Top Languages */}
          <div className="bg-primary-light p-6 rounded-xl border border-accent/20">
            <h3 className="text-xl font-semibold text-accent mb-4">Top Languages</h3>
            
            <div className="space-y-4">
              {[
                { name: "Python", percentage: 40, color: "bg-accent" },
                { name: "SQL", percentage: 25, color: "bg-highlight" },
                { name: "JavaScript", percentage: 20, color: "bg-green-500" },
                { name: "HTML/CSS", percentage: 15, color: "bg-purple-500" }
              ].map((language, index) => (
